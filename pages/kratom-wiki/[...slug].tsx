...
// @ts-ignore
const KratomWikiPage = ({ story }) => {
    // console.log("kratom article detail", story);
...
export async function getStaticProps({ params }: { params: Params }) {
    try {
        ...
        let { data } = await storyblokApi.get(`cdn/stories/kratom-wiki/${params.slug.join('/')}`, {
            version: "draft",
        });
