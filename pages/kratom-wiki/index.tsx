...
// @ts-ignore
const KratomWiki = ({ articles }) => {
    // console.log("news articles", articles);

    return (
        <div className="max-w-7xl mx-auto py-14 px-6 xl:px-0">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 mb-7">Kratom Wiki</h1>
